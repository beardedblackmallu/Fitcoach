      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg flex flex-col max-h-[85vh] scale-in">
        <div className="px-6 pt-5 pb-3 border-b border-stone-100">
          ...
          <h2 className="text-lg font-semibold text-stone-900 pr-6">
            Assign a plan to <span className="text-teal-700">{client.name}</span>
          </h2>
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-2">
          <button
            ...
            className="w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-amber-50 mb-1 border border-transparent hover:border-amber-200"
          >
            <div className="h-9 w-9 rounded-lg bg-amber-100 grid place-items-center text-amber-700 shrink-0">
            ...
            filtered.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="h-9 w-9 rounded-lg bg-teal-50 grid place-items-center text-teal-700 shrink-0">
