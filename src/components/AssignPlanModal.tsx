      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg flex flex-col max-h-[85vh] scale-in">
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-2">
          <button
            ...
            className="w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#FFF2E8] mb-1 border border-transparent hover:border-[#FFD2B0]"
          >
            <div className="h-9 w-9 rounded-lg bg-[#FFF2E8] grid place-items-center text-[#B34700] shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-stone-900 inline-flex items-center gap-1.5">
                ...
                <Sparkles className="h-3 w-3 text-[#FF6400]" />
              </div>
